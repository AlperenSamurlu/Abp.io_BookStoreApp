...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p e26aa50e-2408-4fb2-bcb3-9b30f0af686d
```

> `e26aa50e-2408-4fb2-bcb3-9b30f0af686d` is the password of the certificate, you can change it to any password you want.
